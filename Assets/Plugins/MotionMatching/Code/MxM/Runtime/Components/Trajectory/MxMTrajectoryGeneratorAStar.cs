...
namespace MxM
{
    ...
    *********************************************************************************************/
    ...
    public class MxMTrajectoryGeneratorAStar : MxMTrajectoryGeneratorBase
    {
        ...
        *********************************************************************************************/
        ...
        {
            m_navAgent = GetComponentInChildren<RichAI>();
        ...
        *********************************************************************************************/
        public void LateUpdate()
        {
            ...
            {
                m_navAgent.maxSpeed = Mathf.Clamp(rootSpeed,0, MaxSpeed * .05f);
            }
        ...
        *********************************************************************************************/
        ...
        private Vector3 CalculateDesiredLinearVelocity_AI()
        {
            ...
            {
                if(OnReachDestination != null && !IsAtDestination)
                {
