...
public class LandingSpot:MonoBehaviour{
    ...
    public void LateUpdate() {
        ...
        if(_gotcha){
                Anim = landingChild.GetComponent<Animator>();
        ...
        if (_controller._flock.gameObject.activeInHierarchy && landing && (landingChild != null)) {
            ...
            if (distance < 5 && distance > .5f) {
                if(_controller._soarLand && landingChild._model.GetComponent<Animation>()){
                ...
                if (distance < _controller._snapLandDistance && !_idle) {
                    _idle = true;
                    if (landingChild._model.GetComponent<Animation>()) landingChild._model.GetComponent<Animation>().CrossFade(landingChild._spawner._idleAnimation, .55f); 
    ...
    public void InstantLand() {
        if (_controller._flock.gameObject.activeInHierarchy && (landingChild == null)) {
            ...
            if (fChild != null) {
                ...
                if (landingChild._model.GetComponent<Animation>()) landingChild._model.GetComponent<Animation>().Play(landingChild._spawner._idleAnimation);
    ...
    public void ReleaseFlockChild() {
        ...
        if (_controller._flock.gameObject.activeInHierarchy && (landingChild != null)) {
            ...
            if (landingChild._model.GetComponent<Animation>()) landingChild._model.GetComponent<Animation>().CrossFade(landingChild._spawner._flapAnimation, .2f);
