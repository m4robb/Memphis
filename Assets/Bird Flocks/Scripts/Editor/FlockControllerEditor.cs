...
public class FlockControllerEditor: Editor {
    ...
    public override void OnInspectorGUI() {	
        ...
        target_cs._flockTarget = EditorGUILayout.ObjectField("FlockTarget", target_cs._flockTarget, typeof(Transform), true) as Transform;
        EditorGUILayout.LabelField("Specify flock waypoint destination", EditorStyles.miniLabel);
