...
public class FlockChildBigBird:MonoBehaviour{
    [HideInInspector] 
    public FlockControllerBigBird _spawner;			//Reference to the flock controller that spawned this bird
    [HideInInspector] 
    ...
    public LandingSpotBigBird CurrentLandingSpot;
    ...
    public void OnEnable() {
    	if(_instantiated){
            ...
            AnimationController.CrossFadeInFixedTime(_spawner._flapAnimation, AnimationTransitionTime);
    ...
    public void RandomizeStartAnimationFrame(){
        ...
        AnimationController.SetFloat("Offset", Random.Range(0, 1f));
    ...
    public void RotationBasedOnWaypointOrAvoidance(){
    	...
    	_speed = Mathf.Lerp(_speed, _targetSpeed, _spawner._newDelta* 6f);
    ...
    public void FlapDontFlap()
    {
        if (_move)
        {


            //if (this._model != null) AnimationController.CrossFadeInFixedTime(_spawner._flapAnimation, AnimationTransitionTime);
    ...
    public void Soar(){
    	if(_move){
            if(this._model != null)
                ...
                AnimationController.CrossFadeInFixedTime(_spawner._soarAnimation, AnimationTransitionTime);
    ...
    public void animationSpeed(){
    	//foreach(AnimationState state in _model.GetComponent<Animation>()) {
    		if(!_dived && !_landing){
                AnimationController.SetFloat( "Speed", Random.Range(_spawner._minAnimationSpeed, _spawner._maxAnimationSpeed));
    		}else{
                AnimationController.SetFloat("Speed", _spawner._maxAnimationSpeed);
    		}   
    	//}
    }
}
