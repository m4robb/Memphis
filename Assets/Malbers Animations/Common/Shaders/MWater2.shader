	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 fetchOpaqueVal27 = ASEHDSampleSceneColor(( float3( (ase_grabScreenPosNorm).xy ,  0.0 ) + ( temp_output_13_0 * _Distortion ) ).xy, 0.0, GetInverseCurrentExposureMultiplier());
				...
				surfaceDescription.BaseColor = ( fetchOpaqueVal27 * lerpResult26 ).rgb;
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;536.3718,-251.9704;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=952512B2E4BCC81ED07345863420B550E3AC5379