	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.BaseColor = temp_output_167_0;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_Mask16 = packedInput.ase_texcoord2.xy;
				float4 tex2DNode6 = tex2D( _Mask1, uv_Mask16 );
				...
				float3 hsvTorgb17 = HSVToRGB( float3(( Hue121 * _M1AHue ),( Saturation122 * _M1ASaturation ),( Value123 * _M1AValue )) );
				float3 M1A154 = ( tex2DNode6.a * hsvTorgb17 );
				float2 uv_Mask2222 = packedInput.ase_texcoord2.xy;
				float4 tex2DNode222 = tex2D( _Mask2, uv_Mask2222 );
				float3 hsvTorgb220 = HSVToRGB( float3(( Hue121 * _M2RHue ),( Saturation122 * _M2RSaturation ),( Value123 * _M2RValue )) );
				float3 M2R230 = ( tex2DNode222.r * hsvTorgb220 );
				float3 hsvTorgb221 = HSVToRGB( float3(( Hue121 * _M2GHue ),( Saturation122 * _M2GSaturation ),( Value123 * _M2GValue )) );
				...
				float2 uv_Normal236 = packedInput.ase_texcoord2.xy;
				float3 unpack236 = UnpackNormalScale( tex2D( _Normal, uv_Normal236 ), _NormalIntensity );
				unpack236.z = lerp( 1, unpack236.z, saturate(_NormalIntensity) );
				
				float2 uv_Metalic_Smoothness235 = packedInput.ase_texcoord2.xy;
				float4 tex2DNode235 = tex2D( _Metalic_Smoothness, uv_Metalic_Smoothness235 );
				
				float2 uv_Emission237 = packedInput.ase_texcoord2.xy;
				float4 tex2DNode237 = tex2D( _Emission, uv_Emission237 );
				float3 desaturateInitialColor263 = tex2DNode237.rgb;
				float desaturateDot263 = dot( desaturateInitialColor263, float3( 0.299, 0.587, 0.114 ));
				float3 desaturateVar263 = lerp( desaturateInitialColor263, desaturateDot263.xxx, 1.0 );
...
Node;AmplifyShaderEditor.RangedFloatNode;183;-2655.178,4911.898;Float;False;Property;_M2AValue;M2 A Value;34;0;Create;True;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;50;-2579.615,329.7841;Float;False;Property;_M1RValue;M1 R Value;13;0;Create;True;0;0;0;False;0;False;1;0.64;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;134;-2582.704,1944.515;Inherit;False;121;Hue;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-2633.119,2003.755;Float;False;Property;_M1ASaturation;M1 A Saturation;21;0;Create;True;0;0;0;False;0;False;0.8705882;2;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;132;-2567.581,2129.348;Inherit;False;123;Value;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;42;-2623.943,978.7378;Float;False;Property;_M1GValue;M1 G Value;16;0;Create;True;0;0;0;False;0;False;1;0.32;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;51;-2581.231,225.0372;Float;False;Property;_M1RSaturation;M1 R Saturation;12;0;Create;True;0;0;0;False;0;False;1;1.34;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;182;-2660.437,4569.637;Float;False;Property;_M2AHue;M2 A Hue;32;0;Create;True;0;0;0;False;1;Header(Mask 2 Alpha);False;1;0.94;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;43;-2630.372,827.941;Float;False;Property;_M1GSaturation;M1 G Saturation;15;0;Create;True;0;0;0;False;0;False;1;0.7;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;31;-2608.09,1428.587;Float;False;Property;_M1BSaturation;M1 B Saturation;18;0;Create;True;0;0;0;False;0;False;1;0.7;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;199;-2611.792,2797.006;Float;False;Property;_M2RHue;M2 R Hue;23;0;Create;True;0;0;0;False;1;Header(Mask 2 Red);False;1;0.6;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;184;-2660.378,3318.151;Float;False;Property;_M2GHue;M2 G Hue;26;0;Create;True;0;0;0;False;1;Header(Mask 2 Green);False;1;1.41;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;205;-2646.041,3916.661;Float;False;Property;_M2BHue;M2 B Hue;29;0;Create;True;0;0;0;False;1;Header(Mask 2 Blue);False;1;1.09;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-2629.982,2262.474;Float;False;Property;_M1AValue;M1 A Value;22;0;Create;True;0;0;0;False;0;False;1;0.65;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;32;-2626.122,1590.761;Float;False;Property;_M1BValue;M1 B Value;19;0;Create;True;0;0;0;False;0;False;1;0.41;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;15;-2621.878,1805.306;Float;False;Property;_M1AHue;M1 A Hue;20;0;Create;True;0;0;0;False;1;Header(Mask 1 Alpha);False;1;0.09;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;201;-2648.922,4071.872;Float;False;Property;_M2BSaturation;M2 B Saturation;30;0;Create;True;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;193;-2651.318,4240.185;Float;False;Property;_M2BValue;M2 B Value;31;0;Create;True;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;185;-2649.14,3628.163;Float;False;Property;_M2GValue;M2 G Value;28;0;Create;True;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;200;-2604.811,2979.208;Float;False;Property;_M2RValue;M2 R Value;25;0;Create;True;0;0;0;False;0;False;1;0;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;202;-2568.467,4491.021;Inherit;False;121;Hue;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;52;-2586.596,147.5818;Float;False;Property;_M1RHue;M1 R Hue;11;0;Create;True;0;0;0;False;1;Header(Mask 1 Red);False;1;1.25;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;204;-2655.568,3477.366;Float;False;Property;_M2GSaturation;M2 G Saturation;27;0;Create;True;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;196;-2606.427,2874.462;Float;False;Property;_M2RSaturation;M2 R Saturation;24;0;Create;True;0;0;0;False;0;False;1;2;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;195;-2658.315,4739.358;Float;False;Property;_M2ASaturation;M2 A Saturation;33;0;Create;True;0;0;0;False;0;False;0.8705882;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;30;-2598.042,1252.826;Float;False;Property;_M1BHue;M1 B Hue;17;0;Create;True;0;0;0;False;1;Header(Mask 1 Blue);False;1;1.08;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;41;-2635.182,668.7261;Float;False;Property;_M1GHue;M1 G Hue;14;0;Create;True;0;0;0;False;1;Header(Mask 1 Green);False;1;1.01;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;222;-1735.712,3649.529;Inherit;True;Property;_Mask2;Mask 2;10;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;237;-19.06968,1013.364;Inherit;True;Property;_Emission;Emission;5;1;[NoScaleOffset];Create;True;0;0;0;False;1;Header(Emission);False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;271;599.5974,815.7463;Float;False;Property;_AddEmissiveColor;Add Emissive Color;8;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;265;943.8673,1109.792;Float;False;Property;_EmissionPower;Emission Power;6;0;Create;True;0;0;0;False;0;False;3;1;0;5;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=64403B3F398CBE4B7AC2D848534CFFE7A582807C