	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.BaseColor = temp_output_60_0.rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 appendResult85 = (float2(_TillingOffset.z , _TillingOffset.w));
				float2 texCoord82 = packedInput.ase_texcoord2.xy * appendResult85 + float2( 0,0 );
				float4 temp_output_60_0 = ( tex2D( _Albedo, texCoord82 ) * _AlbedoTint );
...
WireConnection;116;0;60;0
WireConnection;116;1;25;0
WireConnection;116;7;63;0
WireConnection;116;9;66;3
ASEEND*/
//CHKSM=F9D97F2B1F2331C2C2AA7B271729E4A5C980DF6A