	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.BaseColor = ( _AlbedoTint * tex2DNode1 ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_AlbedoRGBOpacityA1 = packedInput.ase_texcoord2.xy;
				float4 tex2DNode1 = tex2D( _AlbedoRGBOpacityA, uv_AlbedoRGBOpacityA1 );
				
				float2 uv_Normal45 = packedInput.ase_texcoord2.xy;
				float3 unpack45 = UnpackNormalScale( tex2D( _Normal, uv_Normal45, float2( 0,0 ), float2( 0,0 ) ), _NormalAmount );
				unpack45.z = lerp( 1, unpack45.z, saturate(_NormalAmount) );
				float3 NormalMap62 = unpack45;
				
				float2 uv_Specular4 = packedInput.ase_texcoord2.xy;
...
WireConnection;93;7;54;0
WireConnection;93;9;1;4
ASEEND*/
//CHKSM=44885DC9D0F213AA10450AD6D9A3DECFFAA8C0FD