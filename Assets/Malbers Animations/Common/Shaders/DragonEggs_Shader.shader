	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.BaseColor = ( saturate( 2.0f*blendOpDest8*blendOpSrc8 + blendOpDest8*blendOpDest8*(1.0f - 2.0f*blendOpSrc8) )).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 lerpResult26 = lerp( _ColorUP , _ColorBotton , texCoord19.y);
				float2 uv_DiffuseMap1 = packedInput.ase_texcoord2.xy;
				float4 blendOpSrc8 = lerpResult26;
				float4 blendOpDest8 = tex2D( _DiffuseMap, uv_DiffuseMap1 );
				
				float2 uv_NormalMap3 = packedInput.ase_texcoord2.xy;
				float3 unpack3 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap3 ), _Normal );
				unpack3.z = lerp( 1, unpack3.z, saturate(_Normal) );
				
				float2 uv_EmmisionMap2 = packedInput.ase_texcoord2.xy;
				float4 blendOpSrc10 = _Emission;
				float4 blendOpDest10 = tex2D( _EmmisionMap, uv_EmmisionMap2 );
				
				float2 uv_RoughnessMap6 = packedInput.ase_texcoord2.xy;
...
/*ASEBEGIN
Version=19103
Node;AmplifyShaderEditor.ColorNode;24;-984.7195,-781.4845;Float;False;Property;_ColorBotton;Color Botton;3;0;Create;True;0;0;0;False;0;False;0,0.5862069,1,0;0.7379313,0,1,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;23;-994.1869,-964.9598;Float;False;Property;_ColorUP;Color UP;2;0;Create;True;0;0;0;False;0;False;1,0,0,0;1,0.3602941,0.3602941,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;2;-401.722,448.6696;Inherit;True;Property;_EmmisionMap;Emmision Map;9;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;9;-386.342,270.701;Float;False;Property;_Emission;Emission;10;1;[HDR];Create;True;0;0;0;False;0;False;1,0.03676468,0.03676468,0;1,0,0,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;16;-593.7974,-36.97682;Float;False;Property;_Rough;Rough;7;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;46;172.1683,566.4698;Float;False;Property;_EmmisionPower;Emmision Power;11;0;Create;True;0;0;0;False;0;False;1;1;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;45;-869.5459,-225.9018;Float;False;Property;_Normal;Normal;5;0;Create;True;0;0;0;False;0;False;0;0.6811765;-3;3;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=2B89D4A8F60E5262C30C25BE2F12EEE9120A82B8