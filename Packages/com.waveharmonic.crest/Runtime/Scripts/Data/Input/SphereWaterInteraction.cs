...
namespace WaveHarmonic.Crest
{
    ...
    sealed class SphereWaterInteraction : ManagedBehaviour<WaterRenderer>, ILodInput
#if UNITY_EDITOR
...
#pragma warning restore 414
        ...
        [Tooltip("Intensity of the forces. Can be set negative to invert.")]
        [@Range(-40f, 40f)]
        [SerializeField]
        float _Weight = 1f;

        [Tooltip("Intensity of the forces from vertical motion of the sphere. scales ripples generated from a sphere moving up or down.")]
        [@Range(0f, 2f)]
        [SerializeField]
...
#pragma warning restore 414
        ...
        {
            base.OnEnable();
            ILodInput.Attach(this, DynamicWavesLod.s_Inputs);
        }

        protected override void OnDisable()
        {
            base.OnDisable();
            ILodInput.Detach(this, DynamicWavesLod.s_Inputs);
        }
