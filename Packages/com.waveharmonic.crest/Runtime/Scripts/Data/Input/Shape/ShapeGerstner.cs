...
{
    /// <summary>
    /// Gerstner water waves.
    /// </summary>
    [AddComponentMenu(Constants.k_MenuPrefixInputs + "Shape Gerstner")]
    sealed partial class ShapeGerstner : ShapeWaves
    {
...
#pragma warning restore 414
        ...
        [Tooltip("Each Gerstner wave is actually a pair of waves travelling in opposite directions (similar to FFT). This weight is applied to the wave travelling in against-wind direction. Set to 0 to obtain simple single waves.")]
        [@Range(0f, 1f, order = -3)]
        [SerializeField]
        ...
        void SliceUpWaves(WaterRenderer water, float windSpeed)
        {
            ...
            var isFilterable = Blend != Blend.Alpha && _Mode != LodInputMode.Renderer;
        ...
        protected override void ReportMaxDisplacement(WaterRenderer water)
        {
            ...
            MaximumHorizontalDisplacement = ampSum * _ActiveSpectrum._Chop;
            MaximumVerticalDisplacement = ampSum;
            MaximumWavesDisplacement = ampSum;
