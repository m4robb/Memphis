...
{
    using FixValidation = System.Action<SerializedObject>;
    ...
    static class ValidatedHelper
    {
        ...
        public delegate void ShowMessage(string message, string fixDescription, MessageType type, Object @object = null, FixValidation action = null);

        public static void DebugLog(string message, string fixDescription, MessageType type, Object @object = null, FixValidation action = null)
        {
        ...
        public static void HelpBox(string message, string fixDescription, MessageType type, Object @object = null, FixValidation action = null)
        {
            s_Messages[(int)type].Add(new() { _Message = message, _FixDescription = fixDescription, _Object = @object, _Action = action });
        }

        public static void Suppressed(string message, string fixDescription, MessageType type, Object @object = null, FixValidation action = null)
        {
        }

        public static void FixAttachComponent<ComponentType>(SerializedObject componentOrGameObject)
            where ComponentType : Component
        {
            Undo.AddComponent<ComponentType>(EditorHelpers.GetGameObject(componentOrGameObject));
        }
            ...
            if (renderer is MeshRenderer)
            {
                ...
                if (mf == null)
                {
                    ...
                    (
                        ...
                        x => Undo.AddComponent<MeshFilter>(renderer.gameObject)
                    );
