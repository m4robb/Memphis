        ...
        internal static readonly Dictionary<string, Dictionary<string, string>> s_Grouped = new()
        {
            ...
            },
            {
                WaterShaderUtility.k_ShaderName, new()
                {
                    ...
                    { "_Crest_AbsorptionColor", "Works as a color (ie red adds red rather than subtracts red). This value is converted to real absorption values (proportion of light getting absorbed by water in atoms per meter). Alpha channel is for density" },
                    { "_Crest_Scattering", "Light scattered by the water towards the viewer (in-scattered) per meter" },
